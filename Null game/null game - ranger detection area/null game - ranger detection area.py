# -*- coding: utf-8 -*-
"""
Created on Sun Feb 7 13:52:00 2016

@author: Lisa

An adaptation to the null game which assumes that the ranger can capture the poacher within
a larger perimeter than his current cell

In the null game, the poacher is caught if he is in the same cell as the ranger. However,
if the terrain is very flat then the ranger may be able to detect the poacher when
he is one cell away. Or perhaps the ranger has technology which allows him
to detect the poacher two or three cells away. We could be more realistic if
we randomize this as well - for each move within a game we
randomize his detecion area over the vector of view sizes (0, 1, 2, 3) as in figure 5.
