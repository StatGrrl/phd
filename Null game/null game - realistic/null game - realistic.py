# -*- coding: utf-8 -*-
"""
Created on Mon Feb 8 09:35:00 2016

@author: Lisa

An adaptation to the null game which includes the additional assumptions:
* the rhino represents a herd and the rhino can possibly remain in the same cell
* two rhino herds are included
* the poacher will not leave immediately if he has not yet poached a rhino
* the ranger can capture the poacher within a larger perimeter than his current cell
