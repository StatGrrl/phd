...
def heading_cell(heading, cell, grid_size, method):
    import numpy as np
    import random
...
for itr in range(reps):
    ...
    for game in range(month_games):
        ...
        while end == 0:
            ...
            ranger_cell = heading_cell(ranger_heading, ranger_cell, grid_size, heading_method)
            poacher_cell = heading_cell(poacher_heading, poacher_cell, grid_size, heading_method)
...
rhino_points = plt.Polygon(rhino_path, closed=None, fill=None, edgecolor='g', label='rhino')
ranger_points = plt.Polygon(ranger_path, closed=None, fill=None, edgecolor='b', label='ranger')
poacher_points = plt.Polygon(poacher_path, closed=None, fill=None, edgecolor='r', label='poacher')
### second herd of rhino
rhino2_points = plt.Polygon(rhino2_path, closed=None, fill=None, edgecolor='y', label='rhino2')
